...
<br>
  ...
  <form class="form-horizontal" role="form" action="{{url('client/store')}}" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="c_name" class="form-control" id="firstname" placeholder="请输入客户名称">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="c_level" class="form-control" id="lastname" placeholder="请输入客户级别（会员，非会员）">
      ...
      <div class="col-sm-5">
        <select name="i_id" class="form-control">
          ...
          @foreach($industry as $k=>$v)
            <option value="{{$v->i_id}}">{{$v->i_industry}}</option>
          @endforeach
          @endif
        </select>
      ...
      <div class="col-sm-5">
        <select name="l_id" class="form-control">
          ...
          @foreach($source as $k=>$v)
            <option value="{{$v->l_id}}">{{$v->l_source}}</option>
          @endforeach
          @endif
        </select>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="c_tels" class="form-control" id="lastname" placeholder="请输入客户电话">
      </div>
    </div>
    <div class="form-group">
      <label for="lastname" class="col-sm-2 control-label">客户手机：</label>
      <div class="col-sm-9">
        <input type="text" name="c_tel" class="form-control" id="lastname" placeholder="请输入客户手机">
